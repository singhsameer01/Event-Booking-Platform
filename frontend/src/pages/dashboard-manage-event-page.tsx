    ...
    const ticketTypes: UpdateTicketTypeRequest[] = eventData.ticketTypes.map(
      (ticketType) => {
        return {
          ...
          ticketsAvailable: ticketType.ticketsAvailable,
        };
      },
    );
                      ...
                      <div className="bg-gray-700 w-full p-4 rounded-lg border-gray-600">
                        <div className="flex justify-between items-center">
                          ...
                          <div>
                            ...
                            {ticketType.ticketsAvailable && (
                              <p className="text-gray-400">
                                {ticketType.ticketsAvailable} tickets available
                              </p>
                            )}
                          </div>
                          {/* Right */}
                  ...
                  <div className="flex gap-4">
                    ...
                    <div className="space-y-1 w-full">
                      ...
                      <Input
                        ...
                        type="number"
                        value={currentTicketType?.ticketsAvailable}
                        onChange={(e) =>
                          setCurrentTicketType(
                            currentTicketType
                              ? {
                                  ...currentTicketType,
                                  ticketsAvailable: Number.parseFloat(
                                    e.target.value,
                                  ),
                                }
                              : undefined,
